...
const ResetPassword = () => {
    ...
    return (  
            <>
              ...
              <motion.div initial={{opacity:0,y:50}} animate={{opacity:1,y:0}} transition={{duration:1,type:'spring',stiffness:100}} className="border border-primary rounded-2xl shadow-xl p-8  w-full sm:w-[70%]">
                <h1 className=" flex text-lg justify-center gap-2 items-center font-semibold"> <span>Forgot Password</span><svg fill="none" width={20} height={20} stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div className="flex flex-col sm:flex-row gap-10 justify-center p-2">
                    ...
                    <div className="flex items-center" >
                        <form onSubmit={handleSubmit}>
                            ...
                            <button className="primary">{ isLoading ? (<div className="newtons-cradle">
