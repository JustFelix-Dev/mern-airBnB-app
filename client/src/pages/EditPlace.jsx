...
const EditPlace = () => {
  ...
  return (
    <>
      <h1 className="text-xl bg-primary text-white font-medium max-w-xl mx-auto rounded-lg text-center py-1 px-8 mt-4">
        Edit Place:
      </h1>
      {fetchedPlace && (
        <div className="border-t-2 border-primary max-w-6xl mt-4 shadow-2xl py-6 px-10 mx-auto ">
