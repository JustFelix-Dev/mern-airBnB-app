...
const UserChat = ({ chat, user }) => {
  ...
  return (
    <>
      <div
        className="flex items-center justify-between m-2 p-2 cursor-pointer relative w-[300px] border-b border-gray-300"
        onClick={() => {
      ...
      >
        ...
        <div className="flex flex-col items-end">
          ...
          <div
            className={
              thisUserNotifications?.length > 0
                ? `flex bg-primary h-[20px] w-[20px] text-xs text-white font-medium rounded-full items-center justify-center`
                : ""
            }
          >
            {thisUserNotifications?.length > 0
          ...
          <span
            className={
              isOnline
                ? "inline-block h-[9px] w-[9px] rounded-full bg-green-400 absolute -top-[3px] -right-[3px] z-2"
                : ""
            }
          ></span>
        </div>
