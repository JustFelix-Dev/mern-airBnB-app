              ...
              <div className=" flex items-center justify-center p-0.5 text-white bg-green-500">
                ...
                <div className=" flex flex-col  p-3 ">
                    {messages && messages.map((message,index)=>(
                        <div key={index} className={`${message?.senderId === user?._id ? " flex flex-col text-white bg-gray-600 p-2 rounded-lg max-w-[50%] mb-1 self-end grow-0" : "flex flex-col bg-primary text-white max-w-[50%] mb-1 rounded-lg p-2 self-start grow-0"}`}>
