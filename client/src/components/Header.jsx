    ...
    <>
      <header className=" px-4 md:px-10 py-3 flex border shadow-sm justify-between ">
        <Link to="/" className="flex items-center gap-1">
          ...
          <span className="font-extrabold text-2xl text-primary hidden lg:block">
            airbnb
          </span>
        </Link>
        {path?.pathname === "/" ? (
          <div className="flex gap-2 items-center md:border border-gray-300 rounded-full pl-6 pr-2 py-3 sm:shadow-md shadow-gray-200 text-sm">
            <div className=" border-r border-gray-300 pr-2 hidden sm:block">
              Anywhere
            </div>
            <div className=" border-r border-gray-300 pr-2 hidden sm:block">
              Any week
          ...
          <div>
            <Link to={"/"}>
              <div className=" cursor-pointer flex gap-3 items-center md:border border-gray-400 md:shadow-lg py-3 px-12 rounded-full">
        ...
        <div className="flex items-center gap-5 ">
          ...
          <div className="hidden sm:block">
            <img src="/images/svgexport-5.svg" alt="" />
          </div>
          <Link
            to={user ? "/account" : "/login"}
            className="flex items-center gap-2 border border-gray-300 rounded-full px-2 py-1"
          >
            <img
            ...
            <div className="flex items-center gap-1 justify-center">
              ...
              <div className="hidden md:block pt-0.5 self-center">
                {user && user.admin && (
                  <div>
                    <svg
                      width={13}
        ...
        {path?.pathname === "/" && showSearch && (
          ...
          >
            <motion.div
              ...
              className="flex flex-col justify-center items-center  border-b border-gray-300 py-2"
            >
              <div className="relative bg-white flex flex-col gap-4 items-center justify-center sm:flex-col md:flex-row">
                ...
                <div className=" flex items-center gap-2">
                  ...
                  <span
                    onClick={handleDate}
                    className=" cursor-pointer text-gray-400 border py-2 px-4 rounded-lg hover:border-primary"
                  ...
                  {openDate && (
                    <DateRange
                      ...
                      ranges={date}
                      className="transition absolute -left-6 top-[315px]  md:top-[110px] md:left-64"
                    />
                  )}
                </div>
                <div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => {
                      handleFilter(location, minValue, maxValue);
                      setShowSearch(false);
                    }}
